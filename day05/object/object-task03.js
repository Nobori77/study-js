...
// function User(name, age, position, salary){
//   this.name = name
//   this.age = age
...
// const user1 = new User("홍길동", 20, "사원", 2_000_000)
// const user2 = new User("이순신", 30, "대리", 2_500_000)
// const user3 = new User("장보고", 25, "사원", 2_100_000)
// const deal = new Deal()

// const users = [user1, user2, user3]


// console.log(user.name + "의 인상된 월급: " + user.salary + "원")
